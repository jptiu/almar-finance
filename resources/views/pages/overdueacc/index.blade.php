<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        @endif
        <div class="relative">
            <h1 class="text-2xl md:text-2xl text-fonts-200 dark:text-slate-100 font-bold mb-4">Overdue Accounts
            </h1>
        </div>
                ...
                <table class="w-full border-collapse text-left text-sm rounded-md overflow-hidden border border-black">
                    <thead class="bg-bgbody-100 rounded-2xl">
                        <tr class="text-fonts-100 font-extrabold">
                            ...
                            <th class="p-4 text-fonts-100 font-normal">Current Balance</th>
                            <th class="p-4 text-fonts-100 font-normal">Days Overdue</th>
                            <th class="p-4 text-fonts-100 font-normal">Total Due</th>
                            <th class="p-4 text-fonts-100 font-normal">Status</th>
                            <th class="p-4 text-fonts-100 font-normal">Assigned Officer</th>
                        </tr>
                    </thead>                    
                    ...
                    <tbody class="text-gray-600 font-semibold text-sm">
                        @foreach($lists as $list)
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="p-4">11/5/2024</td>
                                <td class="p-4">₱15,000</td>
                                <td class="p-4">Early Stage</td>
                                <td class="p-4">Tiu</td>
                            </tr>
                        @endforeach
                    </tbody>
