                                    ...
                                    <div
                                        ...
                                        <div class="grow flex justify-between">
                                            <div class="flex w-full">
                                                <div class="w-1/2 font-medium text-slate-800 hover:text-slate-900 dark:text-slate-100 dark:hover:text-white">
                                                    <p class="font-bold">{{$collection->name}}</p>
                                                    <span class="text-gray-400 text-xs">{{$collection->user->name}}</span>
                                                </div>
                                                <div class="w-1/4 text-slate-800 hover:text-slate-900 dark:text-slate-100 dark:hover:text-white">
                                                    <p class="font-bold">Paid Amout: {{$collection->paid_amount}}</p>
