                    ...
                    <div class="flex items-center justify-center min-h-screen px-4">
                        ...
                        <div
                            ...
                            <form id="modal-form" class="px-6"
                                action="{{ route('loan.request-edit.store', $loan->id) }}" method="POST">
                                @csrf
                                <!-- Date Input -->
                                <div class="mb-4">
            ...
            <div class="grid grid-cols-1 gap-4">
                <div class="...">
                    {{-- <form action="{{ route('customer.store') }}" method="POST"> --}}
                        ...
                        <div class="mb-6">
                            <div class="grid grid-cols-2 gap-8 mt-4 mb-12">
                                <!-- Transaction Details -->
                                <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                                    ...
                                    <div class="space-y-3">
                                        <div>
                                            <p class="text-sm text-gray-500">Transaction No.</p>
                                            <p class="font-bold text-gray-900">{{ $loan->id }}</p>
                                        </div>
                                        <div>
                                            <p class="text-sm text-gray-500">Date of Loan</p>
                                            <p class="font-bold text-gray-900">{{ $loan->date_of_loan }}</p>
                                        </div>
                                        <div>
                                            <p class="text-sm text-gray-500">Loan Type</p>
                                            <p class="font-bold text-gray-900">{{ ucfirst($loan->loan_type) }}</p>
                                        </div>
                                        <div>
                                            <p class="text-sm text-gray-500">Transaction Type</p>
                                            <p class="font-bold text-gray-900">{{ $loan->transaction_type }}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                                    ...
                                    <div class="space-y-2">
                                        <a href="{{ route('printApplicationForm.index', $loan->id) }}"
                                            class="block text-sm text-blue-600 hover:text-blue-800 hover:underline">
                                            Application Form
                                        </a>
                                        <a href="{{ route('printVoucher.index', $loan->id) }}"
                                            class="block text-sm text-blue-600 hover:text-blue-800 hover:underline">
                                            Voucher Form
                                        </a>
                                        <a href="{{ route('printAffidavit.index', $loan->id) }}"
                                            class="block text-sm text-blue-600 hover:text-blue-800 hover:underline">
                                            Affidavit Form
                                        </a>
                                        <a href="{{ route('printSPA.index', $loan->id) }}"
                                            class="block text-sm text-blue-600 hover:text-blue-800 hover:underline">
                                            SPA Form
                                        </a>
                                        <a href="{{ route('printAgreement.index', $loan->id) }}"
                                            class="block text-sm text-blue-600 hover:text-blue-800 hover:underline">
                                            Agreement Form
                                        </a>
                                        <a href="{{ route('printCashBreakdown.index', $loan->id) }}"
                                            class="block text-sm text-blue-600 hover:text-blue-800 hover:underline">
                                            Cash Breakdown Form
                                        </a>
                                        <a href="{{ route('printDisclosureStatement.index', $loan->id) }}"
                                            class="block text-sm text-blue-600 hover:text-blue-800 hover:underline">
                                            Disclosure Statement Form
                                        </a>
                                        <a href="{{ route('printPromissoryATM.index', $loan->id) }}"
                                            class="block text-sm text-blue-600 hover:text-blue-800 hover:underline">
                                            Promissory ATM Form
                                        </a>
                                    </div>
                                                ...
                                                <tbody
                                                    ...
                                                    @foreach ($loan->details as $key => $details)
                                                        <tr>
                                                            ...
                                                            <td
                                                                class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap due-date">
                                                                {{ $principalAmount }}
                                                            </td>
                                                            <td
                                                                class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
