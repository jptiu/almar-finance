<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        @endif
        <div class="relative">
            <h1 class="text-2xl md:text-2xl text-fonts-200 dark:text-slate-100 font-bold mb-4">Chart Accounts
            </h1>
        </div>
        ...
        <section class="container">
            <div class="p-6 w-full max-w-[1500px] mx-auto bg-white rounded-lg border border-bgbody-200">
                <div class="sm:flex sm:justify-between sm:items-center mb-4">
                    ...
                    <a href="{{ route('chart.create') }}" class="btn bg-indigo-500 hover:bg-indigo-600 text-white rounded-full px-4 py-3 flex items-center">
                        ...
                        <span class="hidden xs:block ml-2 text-sm">Add Chart</span>
                    </a>
                ...
                <table class="w-full border-collapse text-left text-sm rounded-md overflow-hidden border border-black">
                    <thead class="bg-bgbody-100 rounded-2xl">
                        <tr class="text-fonts-100 font-extrabold">
                            <th class="p-4 text-fonts-100 font-normal">Account No.</th>
                            <th class="p-4 text-fonts-100 font-normal">Account Class</th>
                            <th class="p-4 text-fonts-100 font-normal">Account Type</th>
                            <th class="p-4 text-fonts-100 font-normal">Account Title</th>
                            <th class="p-4 text-fonts-100 font-normal">Account Description</th>
                    ...
                    <tbody class="text-gray-600 font-semibold text-sm">
                        @foreach ($lists as $list)
                            <tr class="border-b hover:bg-gray-50">
                                <td class="p-4">{{ $list->acc_no }}</td>
                                <td class="p-4">{{ $list->acc_class }}</td>
                                <td class="p-4">{{ $list->acc_type }}</td>
                                <td class="p-4">{{ $list->acc_title }}</td>
                                <td class="p-4">{{ $list->acc_description }}</td>
                                <td class="p-4">
                                    <div class="flex items-center gap-x-6">
                                        ...
                                        <a href="{{ route('barangay.show', $list->id) }}" class="text-gray-500 transition-colors duration-200 hover:text-indigo-500 focus:outline-none">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-pencil"><path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"/><path d="m15 5 4 4"/></svg>
                                        </a>
                    
                                        <form action="{{ route('barangay.destroy', $list->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                <div class="flex items-center gap-x-6">
                                                    ...
                                                    <a href="{{ route('chart.edit', $list->id) }}"
                                                        class="text-gray-500 transition-colors duration-200 dark:hover:text-indigo-500 dark:text-gray-300 hover:text-indigo-500 focus:outline-none">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
