<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        @endif
        <div class="relative">
            <h1 class="text-2xl md:text-2xl text-fonts-200 dark:text-slate-100 font-bold mb-4">Setup Customer
            </h1>
        </div>
                ...
                <div class="sm:flex sm:justify-between sm:items-center mb-4">
                    ...
                    <div class="relative inline-flex" x-data="{ open: false }">
                        <button
                            ...
                            <span class="not-sr-only">Collector</span>
                        </button>
                        <form method="GET" action="{{ route('customerType.index') }}">
                                    ...
                                    @foreach($distinctUserIds as $userid)
                                        <li class="py-1 px-3">
                                            <label class="flex items-center">
                                                <input type="checkbox" name="filter[]" value="{{ $userid }}" class="form-checkbox" />
                                                <span class="text-sm font-medium ml-2">{{ $userid }}</span>
                                            </label>
                                        </li>
                                    @endforeach
                                </ul>
                    ...
                    <a href="{{ route('customerType.add') }}" class="btn bg-indigo-500 hover:bg-indigo-600 text-white rounded-full px-6 py-3 flex items-center">
                        ...
                        <span class="hidden xs:block ml-2">Add Cutomer Type</span>
                    </a>
                ...
                <table class="w-full border-collapse text-left text-sm rounded-md overflow-hidden border border-black">
                    <thead class="bg-bgbody-100 rounded-2xl w-full">
                        <tr class=" text-fonts-100 font-extrabold">
                            <th class="p-4 text-fonts-100 font-normal">Code</th>
                            <th class="p-4 text-fonts-100 font-normal">Description</th>
