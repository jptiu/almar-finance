...
<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="flex items-start grid grid-cols-2 gap-4 mb-4">
            <section class="grid grid-cols-6 gap-4">
                <div
                    class="col-span-3 bg-white rounded-lg border border-slate-200 shadow-[0px_4px_12px_rgba(0,0,0,0.05)] p-4">
                    <div class="px-5 py-5">
                        <div class="flex items-center">
