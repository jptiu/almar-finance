<x-app-layout>
    ...
    <x-dashboard.welcome-banner />
        ...
        <div class="relative">
            <h1 class="text-2xl md:text-2xl text-fonts-200 dark:text-slate-100 font-bold mb-4">Auditor Dashboard</h1>
        </div>
                    ...
                    <form method="GET" action="/" class="flex items-center mx-auto">
                        ...
                        <div class="relative w-[280px]"> <!-- Set width to 280px -->
                            <input type="text" id="search" name="search"
                                ...
                                placeholder="Search collector name..." required />
            ...
            <table class="w-full border-collapse text-left text-sm rounded-md overflow-hidden border border-black">
                <thead class="bg-bgbody-100 rounded-2xl">
                    <tr class="text-fonts-100 font-extrabold">
                        <th class="p-4 text-fonts-100 font-normal">Collector ID</th>
                        <th class="p-4 text-fonts-100 font-normal">Name</th>
                        <th class="p-4 text-fonts-100 font-normal">Branch/Department</th>
