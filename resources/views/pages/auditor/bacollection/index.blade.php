<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="relative">
            <h1 class="text-2xl md:text-2xl text-slate-800 dark:text-slate-100 font-bold mb-12 lg:px-4">BA Collection Report</h1>
        </div>
        ...
        <section class="container px-4 mx-auto">
                ...
                <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                        <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                                <h1 class="mt-4 text-2xl text-center font-bold mb-4">BA Collection OF {{ now()->format('F Y') }}</h1>
                                <table class="min-w-full bg-white">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="py-2 px-4 border">Total Balance</th>
            ...
            <div class="mt-4 text-right">
                <a href="{{ route('bacollection.export') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-800">Export to Excel</a>
            </div>
        </section>
