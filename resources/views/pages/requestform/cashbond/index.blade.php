<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        @endif
        <div class="relative">
            <h1 class="text-2xl md:text-2xl text-slate-800 dark:text-slate-100 font-bold mb-4">Cash Bond Loan
            </h1>
        </div>
                ...
                <table class="w-full border-collapse text-left text-sm rounded-md overflow-hidden border border-black">
                    <thead class="bg-bgbody-100 rounded-2xl">
                        <tr class="text-fonts-100 font-extrabold">
                            ...
                            <th class="p-4 text-fonts-100 font-normal">Print</th>
                        </tr>
                    </thead>                    
                                ...
                                <td class="p-4">
                                    <div class="flex items-center gap-x-2">
                                        ...
                                        <button id="show-approve-modal"
                                            class="bg-indigo-500 hover:bg-indigo-600 text-white flex items-center px-4 py-2 font-semibold rounded-full">
