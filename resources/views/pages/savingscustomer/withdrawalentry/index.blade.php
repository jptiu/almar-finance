<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        @endif
        <div class="relative">
            <h1 class="text-2xl md:text-2xl text-fonts-200 dark:text-slate-100 font-bold mb-4">Savings
                Withdrawal Entry
            </h1>
        </div>
        ...
        <section class="container">
            <div class="p-6 w-full max-w-[1500px] mx-auto bg-white rounded-lg border border-bgbody-200">
                <div class="sm:flex sm:justify-between sm:items-center mb-4">
                    <div>
                    <form method="GET" action="{{ route('savingscustomer.index') }}" class="flex items-center mx-auto">
                    ...
                    <a id="show-modal" href="{{route('withdrawalentry.createWithdrawal')}}" class="btn bg-indigo-500 hover:bg-indigo-600 text-white rounded-full px-6 py-3 flex items-center">
                    ...
                    <a id="show-modal" href="{{route('withdraw.export')}}" class="btn bg-indigo-500 hover:bg-indigo-600 text-white rounded-full px-6 py-3 flex items-center">
                ...
                <table class="w-full border-collapse text-left text-sm rounded-md overflow-hidden border border-black">
                    <thead class="bg-bgbody-100 rounded-2xl">
                        <tr class="text-fonts-100 font-extrabold">
                            ...
                            <th class="p-4 text-fonts-100 font-normal">Tran ID</th>
                            <th class="p-4 text-fonts-100 font-normal">Tran Date</th>
