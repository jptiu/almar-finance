                                                ...
                                                <div
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody
                                                            ...
                                                            @foreach ($cashBillData as $data)
                                                                {{-- No need for `$denomination => $data` --}}
                                                                @if ($data['count'] > 0)
                                                                    <tr>
                                                                        <td
                                                                            class="px-4 py-4 text-sm font-medium text-gray-500 dark:text-gray-200 whitespace-nowrap">
                                                                        ...
                                                                        <table
                                                                            ...
                                                                            <tbody
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td
                                                                                        class="px-4 py-4 text-sm font-medium text-gray-500 dark:text-gray-200 whitespace-nowrap">
                                                                                        {{ number_format($receivableAmountRegular, 2) }}
                                                                                    </td>
                                                                                    <td
                                                                                        class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                                                                        {{ number_format($collectionAmountRegular, 2) }}
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        ...
                                                                        <table
                                                                            ...
                                                                            <tbody
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td
                                                                                        class="px-4 py-4 text-sm font-medium text-gray-500 dark:text-gray-200 whitespace-nowrap">
                                                                                        {{ number_format($receivableAmountCA, 2) }}
                                                                                    </td>
                                                                                    <td
                                                                                        class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                                                                        {{ number_format($collectionAmountCA, 2) }}
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        ...
                                                                        <table
                                                                            ...
                                                                            <tbody
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td
                                                                                        class="px-4 py-4 text-sm font-medium text-gray-500 dark:text-gray-200 whitespace-nowrap">
                                                                                        {{ number_format($receivableAmountBA, 2) }}
                                                                                    </td>
                                                                                    <td
                                                                                        class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                                                                        {{ number_format($collectionAmountBA, 2) }}
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        ...
                                                                        <table
                                                                            ...
                                                                            <tbody
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td
                                                                                        class="px-4 py-4 text-sm font-medium text-gray-500 dark:text-gray-200 whitespace-nowrap">
                                                                                        {{ number_format($receivableAmountCABA, 2) }}
                                                                                    </td>
                                                                                    <td
                                                                                        class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                                                                        {{ number_format($collectionAmountCABA, 2) }}
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
