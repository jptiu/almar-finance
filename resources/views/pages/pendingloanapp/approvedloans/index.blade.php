<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        @endif
        <div class="relative">
            <h1 class="text-2xl md:text-2xl text-slate-800 dark:text-slate-100 font-bold mb-4">Approved Loans
            </h1>
        </div>
                                ...
                                <td class="p-4 text-sm">
                                    <div class="flex items-center gap-x-4">
                                        <a href="{{ route('printStatementBranch.index', $list->id) }}"
                                            class="text-gray-500 transition duration-200 hover:text-indigo-500 focus:outline-none">
