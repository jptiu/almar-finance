<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
       ...
       <div>
            <h1 class="text-2xl md:text-2xl text-slate-800 dark:text-slate-100 font-bold">Collections Data Entry</h1>
                <ol class="inline-flex items-center space-x-2">
                    ...
                    <!-- Page -->
                    <li>
                        <a href="#" class="text-sm text-gray-500">Collections Data Entry</a>
                    </li>
                    <!-- Separator -->
                    <li>
                        <span class="text-gray-500">/</span>
